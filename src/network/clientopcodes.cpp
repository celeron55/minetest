...
const ToClientCommandHandler toClientCommandTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_PHYSICS_SCRIPT",           TOCLIENT_STATE_CONNECTED, &Client::handleCommand_PhysicsScript }, // 0x54
	{ "TOCLIENT_PHYSICS_SCRIPT_MESSAGE",   TOCLIENT_STATE_CONNECTED, &Client::handleCommand_PhysicsScriptMessage }, // 0x55
	null_command_handler,
	null_command_handler,
	null_command_handler,
	null_command_handler,
